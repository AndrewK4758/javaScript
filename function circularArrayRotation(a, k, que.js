function circularArrayRotation(a, k, queries) {
    ...
    if (a.length === k) {
        for (let j = 0; j < queries.length; j++) {
            result.push(parseInt(a[queries[j]]))
        }
    }
    else {
        while (i < k) {
...
console.log(circularArrayRotation(a, 72, quer))
const sol = circularArrayRotation(a, 72, quer)
ans = [596,
29994,
538,
55791,
